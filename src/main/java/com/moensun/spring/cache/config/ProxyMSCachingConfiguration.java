...
import com.moensun.spring.cache.interceptor.MSCacheInterceptor;
import com.moensun.spring.cache.operation.AnnotationMSCacheOperationSource;
...
public class ProxyMSCachingConfiguration extends AbstractMSCachingConfiguration {
    ...
    @Bean(name = "com.moensun.spring.cache.config.RedisInternalCacheAdvisor")
    ...
    @Bean(name = "com.moensun.spring.cache.operation.RedisCacheOperationSource")
    @Role(BeanDefinition.ROLE_INFRASTRUCTURE)
    public MSCacheOperationSource cacheOperationSource() {
        return new AnnotationMSCacheOperationSource();
    }

    @Bean(name = "com.moensun.spring.cache.interceptor.RedisCacheInterceptor")
    @Role(BeanDefinition.ROLE_INFRASTRUCTURE)
